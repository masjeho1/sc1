...
clear
# Link Hosting Kalian
wget -0 https://raw.githubusercontent.com/masjeho1/sc1/main/sstp.sh
chmod +x sstp
IP=$(wget -qO- ipinfo.io/ip);
...
wget -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/masjeho1/sc1/main/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/addsstp https://raw.githubusercontent.com/masjeho1/sc1/main/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://raw.githubusercontent.com/masjeho1/sc1/main/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://raw.githubusercontent.com/masjeho1/sc1/main/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/renewsstp https://raw.githubusercontent.com/masjeho1/sc1/main/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
