...
wget -O /etc/issue.net "https://raw.githubusercontent.com/masjeho1/sc1/main/file/banner.conf"
echo "Banner /etc/issue.net" >>/etc/ssh/sshd_config
sed -i 's@DROPBEAR_BANNER=""@DROPBEAR_BANNER="/etc/issue.net"@g' /etc/default/dropbear

cd /usr/bin
wget -O /usr/bin/system https://raw.githubusercontent.com/masjeho1/sc1/main/menu/system.sh && chmod +x /usr/bin/system && cd /usr/bin && apt install -y dos2unix && dos2unix system
