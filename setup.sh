...
wget https://raw.githubusercontent.com/masjeho1/sc1/main/cf.sh && chmod +x cf.sh && ./cf.sh
#install ssh ovpn
wget https://raw.githubusercontent.com/masjeho1/sc1/main/ssh-vpn.sh && chmod +x ssh-vpn.sh && screen -S ssh-vpn ./ssh-vpn.sh
wget https://raw.githubusercontent.com/masjeho1/sc1/main/sstp.sh && chmod +x sstp.sh && screen -S sstp ./sstp.sh
#install ssr
wget https://raw.githubusercontent.com/masjeho1/sc1/main/ssr.sh && chmod +x ssr.sh && screen -S ssr ./ssr.sh
wget https://raw.githubusercontent.com/masjeho1/sc1/main/sodosok.sh && chmod +x sodosok.sh && screen -S ss ./sodosok.sh
#installwg
wget https://raw.githubusercontent.com/masjeho1/sc1/main/wg.sh && chmod +x wg.sh && screen -S wg ./wg.sh
#install v2ray
wget https://raw.githubusercontent.com/masjeho1/sc1/main/ins-xray.sh && chmod +x ins-xray.sh && screen -S xray ./ins-xray.sh
#install L2TP
wget https://raw.githubusercontent.com/masjeho1/sc1/main/ipsec.sh && chmod +x ipsec.sh && screen -S ipsec ./ipsec.sh
wget https://raw.githubusercontent.com/masjeho1/sc1/main/set-br.sh && chmod +x set-br.sh && ./set-br.sh
# Websocket
wget https://raw.githubusercontent.com/masjeho1/sc1/main/edu.sh && chmod +x edu.sh && ./edu.sh
# Ohp Server
wget https://raw.githubusercontent.com/masjeho1/sc1/main/ohp.sh && chmod +x ohp.sh && ./ohp.sh
wget https://raw.githubusercontent.com/masjeho1/sc1/main/wstunnel-x64-linux && chmod +x wstunnel-x64-linux && ./wstunnel.sh
...
Documentation=https://github.com/masjeho1/sc1"
...
wget -O /etc/set.sh "https://raw.githubusercontent.com/masjeho1/sc1/main/set.sh"
chmod +x /etc/set.sh
history -c
echo "2.9" > /home/ver
echo " "
