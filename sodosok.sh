...
# Link Hosting Kalian
wget -0 https://raw.githubusercontent.com/masjeho1/sc1/main/sodosok.sh"
chmod +x sadosok
...
cd /usr/bin
wget -O addss "https://raw.githubusercontent.com/masjeho1/sc1/main/addss.sh"
wget -O delss "https://raw.githubusercontent.com/masjeho1/sc1/main/delss.sh"
wget -O cekss "https://raw.githubusercontent.com/masjeho1/sc1/main/cekss.sh"
wget -O renewss "https:/raw.githubusercontent.com/masjeho1/sc1/main/renewss.sh"
wget -O /usr/bin/system https://raw.githubusercontent.com/masjeho1/sc1/main/system.sh && chmod +x /usr/bin/system && cd /usr/bin && apt install -y dos2unix && dos2unix system
wget -O /usr/bin/medo https://raw.githubusercontent.com/masjeho1/sc1/main/medo.sh && chmod +x /usr/bin/medo && cd /usr/bin && apt install -y dos2unix && dos2unix medo
wget -O /usr/bin/addcf https://raw.githubusercontent.com/masjeho1/sc1/main/addcf.sh && chmod +x /usr/bin/addcf && cd /usr/bin && apt install -y dos2unix && dos2unix addcf
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x renewss
